        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-3 order-2 lg:order-1">
            <div className="relative">
              <div className="bg-forest-900 rounded-2xl p-6 md:p-8 aspect-[4/5] flex flex-col justify-between transform lg:-translate-y-8">
                {/* Decorative Pattern */}
          ...
          <div className="lg:col-span-3 order-3">
            <div className="relative">
              <div className="bg-cream-100 border-2 border-forest-200 rounded-2xl p-6 md:p-8 aspect-[4/5] flex flex-col justify-between transform lg:translate-y-12">
                {/* Decorative corners */}
